...
command[2]="~/SourceCode/OpenSource/rsync-time-backup/rsync_tmbackup.sh /Users/evatlsong/ui-tech pi:/media/pi/WD/ui-tech exclude_file"
command[1]="~/SourceCode/OpenSource/rsync-time-backup/rsync_tmbackup.sh /Users/evatlsong/SourceCode /Volumes/repository/backup/SourceCode exclude_file"
